...
described in BigMM 2017 paper "Collaborative deep networks for pedestrian 
detection".



This code is based on the UDN code proposed in [a].
...
Before  running our method, you need to download the UDN code firstly at 
...
This code will take several days to finish the training and testing. We are working on acceleration and will release a better version soon.
